...
## Voice
Write everything in the first person, from the user's perspective — as if they wrote these notes themselves. Use "I" and "we", not "the user", "Chinmay", or "Claude". Action items, decisions, and next steps should read as the user's own intentions, not observations about them.

Good: "Confirm recency-handling approach with Jesse before next sprint"
Bad: "Chinmay should confirm his proposal with Jesse"

Good: "10:00 [Salesforce/OrgBuilder] Reviewed sandbox implementation — pausing dev pending gap analysis"
Bad: "Claude reviewed the transcript showing Chinmay decided to pause development"
